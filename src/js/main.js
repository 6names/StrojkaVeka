...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__docElement__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__childNode_remove__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__docElement__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isNodeList__ = __webpack_require__(133);
...
var _browserDetect = __webpack_require__(340);

var _header = __webpack_require__(341);

var _modals = __webpack_require__(342);

var _accordions = __webpack_require__(343);

var _validation = __webpack_require__(344);

var _tinySliderModule = __webpack_require__(345);

// Get Modal
var modalTriggers = document.querySelectorAll('.modal-trigger');
Array.from(modalTriggers).forEach(function (trigger) {
    trigger.addEventListener('click', function (e) {
        (0, _modals.getModal)("modals/" + e.target.getAttribute('data-target') + ".html", function () {
...
// Remove modal
if (_modals.modalHolder) {
    _modals.modalHolder.addEventListener('click', function (e) {
        if (e.target.classList.contains('modal__close')) {
            (0, _modals.removeModal)();
            e.preventDefault();
        }
    });
}
...
function initFunc() {
    ...
    if (orderForm) {
        orderName.addEventListener('blur', function () {
            (0, _validation.validateName)(orderName);
        });
        orderEmail.addEventListener('blur', function () {
            (0, _validation.validateEmail)(orderEmail);
        });
        orderPhone.addEventListener('blur', function () {
            (0, _validation.validatePhone)(orderPhone);
        });
        orderForm.addEventListener('submit', function (e) {
            (0, _validation.validateEmail)(orderName);
            (0, _validation.validateName)(orderEmail);
            (0, _validation.validatePhone)(orderPhone);

            if ((0, _validation.validateName)(orderName) !== true || (0, _validation.validateEmail)(orderEmail) !== true || (0, _validation.validatePhone)(orderPhone) !== true) {
                e.preventDefault();
            } else {
...
// Header categories
(0, _accordions.dropDown)(document.body, '.header__categories-value', '.header__categories-list');
(0, _accordions.dropDown)(document.body, '.header__mobile-categories-value', '.header__mobile-categories-list');
(0, _accordions.dropDown)(document.body, '.header__contacts-location-trigger', '.header__contacts-location-list');
(0, _accordions.dropDown)(document.body, '.header__mobile-location-trigger', '.header__mobile-location-list');

// Close all temporary dropdowns by clicking on document
var main = document.querySelector('.main');
main.addEventListener('click', function () {
    (0, _header.mainNavClose)();
});
...
// Mobile header
(0, _accordions.dropDown)(document.body, '.header__mobile-subnav-trigger', '.header__mobile-subnav-content');

// Slider
var productSlider = void 0;
var productSliderCounter = document.querySelector('.product__header-slider-counter');
var productSliderNext = document.querySelector('.product__header-slider-next');
var productSliderPrev = document.querySelector('.product__header-slider-prev');

if (productSliderCounter) {

    productSlider = (0, _tinySliderModule.tns)({
...
var productData = document.querySelector('.product__header-data');
var productSlide = document.querySelectorAll('.product__header-slide');

function productSlideHeight() {
    if (productData) {
        Array.from(productSlide).forEach(function (slide) {
...
var scrollBlocksArr = Array.from(scrollBlocks);
...
function currentScroll() {
    scrollBlocksArr.forEach(function (block) {
...
function fixedNav() {
    var navHolder = document.querySelector('.page-nav__holder');
    var rect = pageNav.getBoundingClientRect();
...
(function uiIcons() {
    var icons = document.getElementById('ui-icons');
...
exports.mainNavClose = mainNavClose;
exports.mainNavOpen = mainNavOpen;
exports.navClose = navClose;
exports.navDefaultState = navDefaultState;
exports.navScrollToTop = navScrollToTop;
...
if (header) {
    ...
    Array.from(mobileNavItem).forEach(function (item, i) {
        item.addEventListener('click', function () {
            mobileSubnavArr.forEach(function (sub) {
    ...
    Array.from(mobileNavBack).forEach(function (item) {
        item.addEventListener('click', function () {
            navDefaultState();
            navScrollToTop();
        });
...
function navDefaultState() {
    mobileSubnavArr.forEach(function (sub) {
        sub.classList.remove('active');
    });
    mobileNavMain.style.display = 'block';
    Array.from(document.querySelectorAll('.header__mobile-subnav-trigger')).forEach(function (el) {
        el.classList.remove('active');
    });
    Array.from(document.querySelectorAll('.header__mobile-subnav-content')).forEach(function (el) {
        el.classList.remove('active');
    });
    navScrollToTop();
}
...
var modalHolder = exports.modalHolder = document.getElementById('modal-holder');
...
// Get modal
function getModal(target, callBack) {
    var xhr = new XMLHttpRequest();
...
// Accordions
function accordion(parent, triggers, content) {
    Array.from(parent.querySelectorAll(triggers)).forEach(function (trigger) {
        trigger.addEventListener('click', function () {
            if (trigger.classList.contains('active')) {
                ...
                try {
                    for (var _iterator2 = document.querySelectorAll(content)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function validatePhone(target) {
    var phone = target;
    var re = /^(\+7|\+8|7|8)+\(?\d{3}\)?\d{3}\-?\d{2}-?\d{2}$/;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__helpers_keys__ = __webpack_require__(346);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_childNode_remove__ = __webpack_require__(49);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_extend__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_checkStorageValue__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_setLocalStorage__ = __webpack_require__(349);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helpers_getSlideId__ = __webpack_require__(350);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__helpers_calc__ = __webpack_require__(351);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__helpers_subpixelLayout__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__helpers_mediaquerySupport__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__helpers_createStyleSheet__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__helpers_addCSSRule__ = __webpack_require__(355);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__helpers_getCssRulesLength__ = __webpack_require__(356);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__helpers_toDegree__ = __webpack_require__(357);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__helpers_getTouchDirection__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__helpers_hasClass__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__helpers_addClass__ = __webpack_require__(359);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__helpers_removeClass__ = __webpack_require__(360);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__helpers_hasAttr__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__helpers_getAttr__ = __webpack_require__(361);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__helpers_setAttrs__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__helpers_removeAttrs__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__helpers_removeElementStyles__ = __webpack_require__(362);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__helpers_hideElement__ = __webpack_require__(363);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__helpers_showElement__ = __webpack_require__(364);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__helpers_isVisible__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__helpers_imageLoaded__ = __webpack_require__(366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__helpers_whichProperty__ = __webpack_require__(367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__helpers_getEndProperty__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__helpers_addEvents__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__helpers_removeEvents__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__helpers_events__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__helpers_jsTransform__ = __webpack_require__(372);
// Format: ES MODULE
// Version: 2.6.0
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__childNode_remove__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__childNode_remove___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__childNode_remove__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getBody__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setFakeBody__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__resetFakeBody__ = __webpack_require__(93);
// get css-calc 
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hasClass__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hasAttr__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__setAttrs__ = __webpack_require__(132);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hasAttr__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__removeAttrs__ = __webpack_require__(134);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__passiveOption__ = __webpack_require__(135);
